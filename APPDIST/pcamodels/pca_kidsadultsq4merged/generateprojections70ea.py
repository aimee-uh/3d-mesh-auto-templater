...
#python generateprojections70ea.py m_pca_superset m_average_superset_n.ply ../../../pcatemplate_kids/pca_super/superset/trainingmeshes/males/ ../../../separatepcperdevice_102920/autofittedplys/SUPERSETTRAINAUGMESHES_TRAINING/males/
...
trainingmeshes = glob.glob(sys.argv[3] + '/*.ply') + glob.glob(sys.argv[4] + '/*.ply')
