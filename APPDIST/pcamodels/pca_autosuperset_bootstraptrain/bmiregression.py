...
for line in pcvecs:
    ...
    height = float(dxaline[htindx]) / 100.0 
    wtcbrt = (float(dxaline[wtindx]) / 1000.0) ** cbrtexp
    inputFeatures[0, i] = wtcbrt / pow(height, 2)   #bmi
    inputFeatures[1, i] = 1
...
mbinname = "male_bmitoallstats_"
if gender == "1":
    mbinname = "female_bmitoallstats_"
...
ftopname = "male_bmitoallstats"
if gender == "1":
    ftopname = "female_bmitoallstats"
