...
/* Subroutine */ int lbfgsb(n, m, x, l, u, nbd, f, g, factr, pgtol, wa, iwa, 
...
ftnlen csave_len;
{
    ...
    integer i__1;
//	printf("system do something her\n");
...
/* Computing 2nd power */
    ...
    lt = isave[15];
    lwa = isave[16];
//	printf("after copy all the varibles\n");
...
//	printf("get value_ %d\n", i__1);
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
			//nbd or l is not right in 264704??
